...
SRC_URI = " \
    ...
    file://0001-route-treat-nhid-changes-as-full-route-replacements.patch \
    file://0002-link-bonding-add-primary-getters-and-setters.patch \
    ...
    file://0007-link-ignore-incomplete-bridge-updates.patch \
"
