...
do_install:append() {
  install -g 0 -o 0 -m 0644 ${UNPACKDIR}/basebox-*.1 ${D}${datadir}/man/man1/
  gzip ${D}${datadir}/man/man1/basebox-*.1

  install -g 0 -o 0 -m 0644 ${UNPACKDIR}/onie-*.1 ${D}${datadir}/man/man1/
  gzip ${D}${datadir}/man/man1/onie-*.1

  install -g 0 -o 0 -m 0644 ${UNPACKDIR}/switch_tcpdump.8 ${D}${datadir}/man/man8/
